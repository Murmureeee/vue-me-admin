...
import { bindMethods } from './tools'

const getParamsSerializer = (paramsSerializer: RequestClientOptions['paramsSerializer']) => {
...
class RequestClient {
   ...
   * DELETE请求方法
   */
  public delete<T = any>(url: string, data?: any, config?: RequestClientConfig): Promise<T> {
   ...
   * GET请求方法
   */
  public get<T = any>(url: string, params?: any, config?: RequestClientConfig): Promise<T> {
